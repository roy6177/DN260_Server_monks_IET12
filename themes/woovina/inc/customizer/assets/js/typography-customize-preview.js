	...
	api("body_typography[font-family]", function($swipe) {
		$swipe.bind(function(pair) {
			if(pair) {
				...
				/** @type {string} */
				fontSize = woovina.googleFontsUrl + "/css?family=" + pair + ":" + woovina.googleFontsWeight;
				if($("#" + idfirst).length) {
		...
		$swipe.bind(function(pair) {
			...
			if(pair) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-font-family">h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{font-family: ' + pair + ";}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-font-weight">h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{font-weight: ' + dataAndEvents + ";}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-font-style">h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{font-style: ' + dataAndEvents + ";}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-font-size">h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{font-size: ' + dataAndEvents + ";}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-tablet-font-size">@media (max-width: 768px){h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{font-size: ' + dataAndEvents + ";}}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-mobile-font-size">@media (max-width: 480px){h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{font-size: ' + dataAndEvents + ";}}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-color">h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{color: ' + dataAndEvents + ";}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-line-height">h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{line-height: ' + dataAndEvents + ";}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-tablet-line-height">@media (max-width: 768px){h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{line-height: ' + dataAndEvents + ";}}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-mobile-line-height">@media (max-width: 480px){h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{line-height: ' + dataAndEvents + ";}}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-letter-spacing">h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{letter-spacing: ' + dataAndEvents + "px;}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-tablet-letter-spacing">@media (max-width: 768px){h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{letter-spacing: ' + dataAndEvents + "px;}}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-mobile-letter-spacing">@media (max-width: 480px){h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{letter-spacing: ' + dataAndEvents + "px;}}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
		...
		$swipe.bind(function(dataAndEvents) {
			...
			if(dataAndEvents) {
				/** @type {string} */
				var img = '<style class="customizer-typography-headings-text-transform">h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.woovina-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title{text-transform: ' + dataAndEvents + ";}</style>";
				if($child.length) {
					$child.replaceWith(img);
				} else {
					$("head").append(img);
