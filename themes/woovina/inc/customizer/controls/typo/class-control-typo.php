<?php
/**
 * Customizer Control: woovina-typo.
 *
 ...
 * Typography control
 */
class WooVina_Customizer_Typo_Control extends WP_Customize_Control {
	...
	public function __construct($manager, $id, $args = array()) {
		...
		$this->l10n = wp_parse_args(
			$this->l10n,
			array(
				'family'      	=> esc_html__('Font Family', 'woovina'),
				'size'        	=> esc_html__('Font Size',   'woovina'),
				'weight'      	=> esc_html__('Font Weight', 'woovina'),
				'style'      	=> esc_html__('Font Style',  'woovina'),
				'transform' 	=> esc_html__('Text Transform', 'woovina'),
				'line_height' 	=> esc_html__('Line Height', 'woovina'),
				'spacing' 		=> esc_html__('Letter Spacing', 'woovina'),
			)
		);
	}
	...
	public function enqueue() {
		...
		wp_enqueue_script('woovina-typo-js', WOOVINA_INC_DIR_URI . 'customizer/assets/min/js/typo.min.js', array('jquery', 'customize-base', 'select2'), false, true);
		wp_enqueue_style('woovina-typo', WOOVINA_INC_DIR_URI . 'customizer/assets/min/css/typo.min.css', null);
	}
		...
		<ul class="woovina-typo-wrap">
			...
			<# if(data.size) { #>
				<li class="typography-font-size">
					...
					<input type="text" name="{{ data.size.name }}" value="{{ data.size.value }}" placeholder="<?php esc_html_e('px - em - rem', 'woovina'); ?>" />
			...
			<# if(data.line_height) { #>
				<li class="typography-line-height">
					...
					<input type="text" name="{{ data.line_height.name }}" value="{{ data.line_height.value }}" placeholder="<?php esc_html_e('px - em - rem', 'woovina'); ?>" />
			...
			<# if(data.spacing) { #>
				<li class="typography-letter-spacing">
					...
					<input type="text" name="{{ data.spacing.name }}" value="{{ data.spacing.value }}" placeholder="<?php esc_html_e('px - em - rem', 'woovina'); ?>" />
	...
	public function get_font_families() {
		...
		$fonts 	= array('' => esc_html__('Default', 'woovina'));
		$id 	= '';
