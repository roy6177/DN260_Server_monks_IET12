wp.customize.controlConstructor['woovina-slider'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		var control = this,
			desktop_slider 			= control.container.find('.woovina-slider.desktop-slider'),
			desktop_slider_input 	= desktop_slider.next('.woovina-slider-input').find('input.desktop-input'),
			tablet_slider 			= control.container.find('.woovina-slider.tablet-slider'),
			tablet_slider_input 	= tablet_slider.next('.woovina-slider-input').find('input.tablet-input'),
			mobile_slider 			= control.container.find('.woovina-slider.mobile-slider'),
			mobile_slider_input 	= mobile_slider.next('.woovina-slider-input').find('input.mobile-input'),
			slider_input,
			$this,
			val;
		...
		jQuery('input.desktop-input').on('change keyup paste', function() {
			$this 			= jQuery(this);
			val 			= $this.val();
			slider_input 	= $this.parent().prev('.woovina-slider.desktop-slider');
		...
		jQuery('input.tablet-input').on('change keyup paste', function() {
			$this 			= jQuery(this);
			val 			= $this.val();
			slider_input 	= $this.parent().prev('.woovina-slider.tablet-slider');
		...
		jQuery('input.mobile-input').on('change keyup paste', function() {
			$this 			= jQuery(this);
			val 			= $this.val();
			slider_input 	= $this.parent().prev('.woovina-slider.mobile-slider');
