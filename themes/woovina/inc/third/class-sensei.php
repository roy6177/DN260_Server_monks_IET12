...
if(! class_exists('WooVina_Sensei')) :

	class WooVina_Sensei {
		...
		public function __construct() {
			...
			add_action('woovina_main_metaboxes_post_types', array($this, 'add_metabox'), 20);
		...
		public static function add_custom_css() {
			if(is_sensei() || is_tax('module')) {
				wp_enqueue_style('woovina-sensei', WOOVINA_CSS_DIR_URI .'third/sensei.min.css');
			}
		}
		...
		public static function wrapper_start() {
			...
			<div id="content-wrap" class="container woovina-sensei clr">
		...
		/**
		 * Add the WooVina Settings metabox into the custom post types
		 *
		 * @since 1.4.0
		 */
