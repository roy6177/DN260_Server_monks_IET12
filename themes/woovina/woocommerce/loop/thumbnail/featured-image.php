...
// Display placeholder
	...
	<div class="woo-entry-image clr">
		<?php do_action('woovina_before_product_entry_image'); ?>
		<a href="<?php the_permalink(); ?>" class="woocommerce-LoopProduct-link">
    		<?php echo '<img src="'. esc_url(wc_placeholder_img_src()) .'" alt="'. esc_html__('Placeholder Image', 'woovina') .'" class="woo-entry-image-main" />'; ?>
    	</a>
		<?php do_action('woovina_after_product_entry_image'); ?>
	</div><!-- .woo-entry-image -->
<?php } ?>