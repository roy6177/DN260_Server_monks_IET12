...
$products_per_page = get_theme_mod('woovina_woo_shop_posts_per_page', '12');
 ...
 */
$link = apply_filters('woovina_num_products_link', $link);
...
<ul class="result-count">
    <li class="view-title"><?php esc_html_e('View:', 'woovina') ?></li>
    ...
    <li><a class="view-all<?php if($num_prod == 'all') echo ' active'; ?>" href="<?php echo esc_url(add_query_arg('products-per-page', 'all', $link )) ?>"><?php esc_html_e('All', 'woovina') ?></a></li>
</ul>
