	...
	$('ul.products.woovina-row.grid li.product, div.wew-woo-slider ul.products li.product').each(function(index, item) {
		...
		var btnpositions = $('<div class="btn-positions"></div>');
		...
		$(addtocart).appendTo($(btnpositions));
		$(wishlist).appendTo($(btnpositions));
		$(compare).appendTo($(btnpositions));
		$(quickview).appendTo($(btnpositions));
		$(btnpositions).appendTo($(imgwrapper));        
		$(btnpositions).clone().appendTo($(imgwrapper));
		$(btnpositions).appendTo($(btnwrap))
		...
		if($(countdown).length) {
            ...
            $(countdown).clone().appendTo($(imgwrapper));
