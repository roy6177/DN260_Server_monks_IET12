jQuery(function ($) {
	...
	$('ul.products.grid li.product, div.wew-woo-slider ul.products li.product').each(function(index, item) {
        ...
        quickview = $(item).find('div.btn-qwc.btn-quickview a');
        wishlist = $(item).find('div.btn-qwc.btn-wishlist a');
        compare = $(item).find('div.btn-qwc.btn-compare a');
    ...
    $("h5").on("click", function (){
		$(".product-categories").slideToggle("300", "linear");
	})
});