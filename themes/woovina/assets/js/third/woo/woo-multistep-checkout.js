...
$j(document).on('ready', function() {
    ...
    woovinaWooMultiStepCheckout();
});

/* ==============================================
WOOCOMMERCE MULTI-STEP CHECKOUT
============================================== */
function woovinaWooMultiStepCheckout() {
	"use strict"
    ...
    form_actions.find('.button.prev').add('.button.next').on('click', function(e) {
        var $this 			= $j(this),
            timeline 		= $j('#wvn-checkout-timeline'),
            ...
            is_logged_in    = woovinaLocalize.is_logged_in,
            button_title;
        ...
        if((current_step == 1
            ...
            (is_logged_in == false
            	&& ((current_step == 0
            		&& woovinaLocalize.login_reminder_enabled == 1)
            	||  (current_step == 1
            		&& woovinaLocalize.login_reminder_enabled == 0)))) {
            prev.fadeOut(120);
        } else {
            prev.fadeIn(120);
        }
        ...
        if(is_logged_in == false
            && ((current_step == 0
                ...
                ||  (current_step == 1
                    && woovinaLocalize.login_reminder_enabled == 0)) ) {
            next.val(woovinaLocalize.no_account_btn);
        } else {
            next.val(woovinaLocalize.next);
        }
