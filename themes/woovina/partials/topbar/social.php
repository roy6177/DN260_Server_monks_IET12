...
$classes = '';
$topbar_style = get_theme_mod('woovina_top_bar_style', 'one');
if('one' == $topbar_style) {
...
// Get ID
$get_id = get_theme_mod('woovina_top_bar_social_alt_template');

// Check if page is Elementor page
$elementor = get_post_meta($get_id, '_elementor_edit_mode', true);

// Get content
$get_content = woovina_top_bar_social_alt_content();
...
if($get_id) : ?>
	...
	<div id="top-bar-social-alt" class="clr <?php echo esc_attr($classes); ?>">
	    ...
	    if(WOOVINA_ELEMENTOR_ACTIVE && $elementor) {
	        ...
	        WooVina_Elementor::get_topbar_social_alt_content();
...
if(! $profiles = get_theme_mod('woovina_top_bar_social_profiles')) {
	return;
}

// Get theme mods
$link_target = get_theme_mod('woovina_top_bar_social_target', 'blank');
