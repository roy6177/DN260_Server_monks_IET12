...
// Get template ID
$get_id = get_theme_mod('woovina_menu_social_template');

// Check if page is Elementor page
$elementor  = get_post_meta($get_id, '_elementor_edit_mode', true);

// Get content
$get_content = woovina_social_menu_content();

// Style
$style = get_theme_mod('woovina_menu_social_style', 'simple');
$style = $style ? $style : 'simple';

// Classes
$classes = array('woovina-social-menu', 'clr');
...
if((! $profiles = get_theme_mod('woovina_menu_social_profiles'))
	&& empty($get_content)) {
	return;
}

// Get theme mods
$link_target = get_theme_mod('woovina_menu_social_target', 'blank'); ?>
	...
	<div class="<?php echo esc_attr($inner_classes); ?>">
        ...
        if(! empty($get_id)) {
		    ...
		    if(WOOVINA_ELEMENTOR_ACTIVE && $elementor) {
		        ...
		        WooVina_Elementor::get_social_menu_content();
