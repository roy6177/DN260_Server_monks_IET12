...
// Start Class
class OEW_Instagram_API {

	/**
	 * @var OEW_Instagram_API The reference to *Singleton* instance of this class
	 */
	 ...
	 *
	 * @return OEW_Instagram_API The *Singleton* instance.
	 */
	...
	public function get_media($access_token, $number, $id) {
		...
		$key        = 'wew_instagram_media_transient_' . $id; // transient name
	...
	public function get_infos($access_token, $id) {
		...
		$key        = 'wew_instagram_info_transient_' . $id; // transient name
		$expiration = 60 * 60 * 24; // 24 hours
