<?php
namespace wvnElementor\Modules\NinjaForms\Widgets;
...
class Ninja_Forms extends Widget_Base {
	...
	public function get_title() {
		return __('Ninja Forms', 'woovina-elementor-widgets');
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'form_title',
			[
				'label' 		=> __('Hide Title', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			...
			[
				'label' 		=> __('Not Valid Input', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
				'separator' 	=> 'before',
			]
		);
		...
		$this->add_control(
			'ninja_invalid_inputs_border_color',
			[
				'label' 		=> __('Input Border Color', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
		...
		$this->add_control(
			'error_heading',
			[
				'label' 		=> __('Sent Error', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
				'separator' 	=> 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' 		=> __('Required Fields Notice', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
				'separator' 	=> 'before',
			]
		);
