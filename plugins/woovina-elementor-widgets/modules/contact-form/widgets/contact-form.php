<?php
namespace wvnElementor\Modules\ContactForm\Widgets;
...
class Contact_Form extends Widget_Base {
	...
	public function get_title() {
		return __('Contact Form 7', 'woovina-elementor-widgets');
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' 		=> __('Not Valid Notices', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			'sent_heading',
			[
				'label' 		=> __('Sent Success', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
				'separator' 	=> 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' 		=> __('Not Valid', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
				'separator' 	=> 'before',
			]
		);
		...
		$this->add_control(
			'spam_heading',
			[
				'label' 		=> __('Spam Blocked', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
				'separator' 	=> 'before',
			]
		);
