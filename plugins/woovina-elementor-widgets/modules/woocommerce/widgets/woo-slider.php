...
class Woo_Slider extends Widget_Base {
	...
	public function get_name() {
		return 'wew-woo-slider';
	}

	public function get_title() {
		return __('Woo - Slider', 'woovina-elementor-widgets');
	}
	...
	public function get_script_depends() {
		return [ 'wew-woo-slider', 'jquery-slick' ];
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_woo_slider',
			[
				'label' 		=> __('Slider', 'woovina-elementor-widgets'),
			]
		);
		...
		$this->add_responsive_control(
			'slides_to_show',
			[
				'label' 		=> __('Products To Display', 'woovina-elementor-widgets'),
		...
		$this->add_responsive_control(
			'slides_to_scroll',
			[
				'label' 		=> __('Products To Scroll', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::NUMBER,
				'default' 		=> '4',
				'tablet_default' => '2',
				'mobile_default' => '1',
		...
		$this->add_control(
			'transition_speed',
			[
				'label'     	=> __('Transition Speed (ms)', 'woovina-elementor-widgets'),
				'type'      	=> Controls_Manager::NUMBER,
				'default'  	 	=> 500,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> 'all',
				'options' 		=> [
					'all'    => __('All Products', 'woovina-elementor-widgets'),
					'custom' => __('Custom Query', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			...
			[
				'label'     	=> __('Cat Filter Rule', 'woovina-elementor-widgets'),
				'type'      	=> Controls_Manager::SELECT,
				'default'   	=> 'IN',
				'options'   	=> [
					'IN'     => __('Match Categories', 'woovina-elementor-widgets'),
					'NOT IN' => __('Exclude Categories', 'woovina-elementor-widgets'),
				],
				'condition' 	=> [
					'query_type' => 'custom',
				],
		...
		$this->add_control(
			'category_filter',
			[
				'label'     	=> __('Select Categories', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			'tag_filter_rule',
			[
				'label'     	=> __('Tag Filter Rule', 'woovina-elementor-widgets'),
				'type'      	=> Controls_Manager::SELECT,
				'default'   	=> 'IN',
				'options'   	=> [
					'IN'     => __('Match Tags', 'woovina-elementor-widgets'),
					'NOT IN' => __('Exclude Tags', 'woovina-elementor-widgets'),
				],
				'condition' 	=> [
					'query_type' => 'custom',
				],
		...
		$this->add_control(
			'tag_filter',
			[
				'label'     	=> __('Select Tags', 'woovina-elementor-widgets'),
				'type'      	=> Controls_Manager::SELECT2,
				'multiple'  	=> true,
				'default'   	=> '',
		...
		$this->add_control(
			...
			[
				...
				'type'        	=> Controls_Manager::NUMBER,
				'default'     	=> 0,
				'description' 	=> __('Number of post to displace or pass over.', 'woovina-elementor-widgets'),
				'condition'   	=> [
					'query_type' => 'custom',
				],
			]
		...
		$this->add_control(
			'query_manual_ids',
			[
				'label'     	=> __('Select Products', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			'query_exclude',
			[
				'label'     	=> __('Exclude', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			...
			[
				...
				'post_type'   	=> 'product',
				'multiple'    	=> true,
				'description' 	=> __('Select products to exclude from the query.', 'woovina-elementor-widgets'),
				'condition'   	=> [
					'query_type!' => 'manual',
				],
			]
		...
		$this->add_control(
			...
			[
				'label'        	=> __('Exclude Current Product', 'woovina-elementor-widgets'),
				'type'         	=> Controls_Manager::SWITCHER,
				'label_on'     	=> __('Yes', 'woovina-elementor-widgets'),
				'label_off'    	=> __('No', 'woovina-elementor-widgets'),
				'return_value' 	=> 'yes',
				'default'      	=> '',
				'description'  	=> __('Enable this option to remove current product from the query.', 'woovina-elementor-widgets'),
				'condition'    	=> [
					'query_type!' => 'manual',
				],
			]
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' 		=> __('Products Count', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::NUMBER,
				'default' 		=> '8',
			]
		);
		...
		$this->add_control(
			'advanced',
			[
				'label' 		=> __('Advanced', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			'filter_by',
			[
				'label' 		=> __('Filter By', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::SELECT,
				'default' 		=> '',
				'options' 		=> [
					'' 			=> __('None', 'woovina-elementor-widgets'),
					'featured' 	=> __('Featured', 'woovina-elementor-widgets'),
					'sale' 		=> __('Sale', 'woovina-elementor-widgets'),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' 		=> [
					...
					'price' 		=> __('Price', 'woovina-elementor-widgets'),
					'popularity' 	=> __('Popularity', 'woovina-elementor-widgets'),
					'rating' 		=> __('Rating', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			...
			[
				...
				'selectors' 	=> [
					'{{WRAPPER}} .wew-woo-slider ul.products > .slick-arrow' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-woo-slider ul.products > .slick-arrow:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .woocommerce .products .wvn-content-center .product-inner' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' 			=> 'item_border',
				'placeholder' 	=> '1px',
				'selector' 		=> '{{WRAPPER}} .woocommerce .products .wvn-content-center .product-inner',
				'separator' 	=> 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%' ],
				'selectors' 	=> [
					'{{WRAPPER}} .woocommerce .products .wvn-content-center .product-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', 'em', '%' ],
				'selectors' 	=> [
					'{{WRAPPER}} .woocommerce .products .wvn-content-center .product-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' 	=> 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', 'em', '%' ],
				'selectors' 	=> [
					'{{WRAPPER}} .woocommerce .products .wvn-content-center .product-inner' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'category_heading',
			[
				'label' 		=> __('Category', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			'price_color',
			[
				'label'     	=> esc_html__('Price Color', 'woovina-elementor-widgets'),
				'type'      	=> Controls_Manager::COLOR,
				'selectors' 	=> [
		...
		$this->add_control(
			'del_price_color',
			[
				'label'     	=> esc_html__('Del Price Color', 'woovina-elementor-widgets'),
				'type'      	=> Controls_Manager::COLOR,
				'separator' 	=> 'before',
				'selectors' 	=> [
		...
		$this->add_control(
			'rating_fill_color',
			[
				'label'     	=> esc_html__('Fill Color', 'woovina-elementor-widgets'),
				'type'      	=> Controls_Manager::COLOR,
				'selectors' 	=> [
		...
		$this->start_controls_section(
			'section_badge_style',
			[
				'label' 		=> __('Badge', 'woovina-elementor-widgets'),
				'tab' 			=> Controls_Manager::TAB_STYLE,
			]
		);
	...
	public function render() {
		...
		echo '<div class="wew-woo-slider woocommerce columns-' . $woocommerce_loop['columns'] . '" '. $this->get_render_attribute_string('data') .'>';

			echo '<ul class="products woovina-row clr">';
