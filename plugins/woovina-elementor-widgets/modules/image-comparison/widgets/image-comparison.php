<?php
namespace wvnElementor\Modules\ImageComparison\Widgets;
...
class ImageComparison extends Widget_Base {
	...
	public function get_name() {
		return 'wew-image-comparison';
	}

	public function get_title() {
		return __('Image Comparison', 'woovina-elementor-widgets');
	}

	public function get_icon() {
		// Upload "eicons.ttf" font via this site: http://bluejamesbond.github.io/CharacterMap/
		return 'wew-icon eicon-image-before-after';
	}
	...
	public function get_script_depends() {
		return [ 'wew-image-comparison', 'twentytwenty', 'event-move' ];
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' 		=> __('Before Image', 'woovina-elementor-widgets'),
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'default' 		=> __('Before', 'woovina-elementor-widgets'),
				'dynamic' 		=> [ 'active' => true ],
            ]
       );
        ...
        $this->start_controls_section(
            'section_after_image',
            [
                'label' 		=> __('After Image', 'woovina-elementor-widgets'),
            ]
       );
        ...
        $this->add_control(
            ...
            [
                'label' 		=> __('Label', 'woovina-elementor-widgets'),
                'type' 			=> Controls_Manager::TEXT,
                'default' 		=> __('After', 'woovina-elementor-widgets'),
				'dynamic' 		=> [ 'active' => true ],
            ]
       );
        ...
        $this->add_control(
            'visible_ratio',
            [
                'label' 		=> __('Visible Ratio', 'woovina-elementor-widgets'),
        ...
        $this->add_control(
            'orientation',
            [
                'label' 		=> __('Orientation', 'woovina-elementor-widgets'),
        ...
        $this->add_control(
            'move_slider',
            [
                'label' 		=> __('Move Slider', 'woovina-elementor-widgets'),
                'type' 			=> Controls_Manager::SELECT,
                'default' 		=> 'drag',
                'options' 		=> [
                    'drag'          => __('Drag', 'woovina-elementor-widgets'),
                    'mouse_move'    => __('Mouse Move', 'woovina-elementor-widgets'),
                    'mouse_click'   => __('Mouse Click', 'woovina-elementor-widgets'),
                ],
            ]
       );
        ...
        $this->add_control(
            'before_after',
            [
                'label' 		=> __('Before/After Labels', 'woovina-elementor-widgets'),
        ...
        $this->start_controls_tab(
            'tab_label_before',
            [
                'label' 		=> __('Before', 'woovina-elementor-widgets'),
				'condition' 	=> [
					'before_after' => 'yes',
				],
            ]
        ...
        $this->start_controls_tab(
            'tab_label_after',
            [
                'label' 		=> __('After', 'woovina-elementor-widgets'),
				'condition' 	=> [
					'before_after' => 'yes',
				],
            ]
		...
		$this->add_responsive_control(
			...
			[
				'label' 		=> __('Horizontal Alignment', 'woovina-elementor-widgets'),
				...
				'prefix_class' => 'wew-label-horizontal-'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' 		=> __('Vertical Alignment', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::CHOOSE,
				'options' 		=> [
					'left' => [
				...
				'prefix_class' => 'wew-label-vertical-'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' 		=> __('Handle', 'woovina-elementor-widgets'),
				'tab' 			=> Controls_Manager::TAB_STYLE,
			]
		);
