<?php
namespace wvnElementor\Modules\BlogGrid\Widgets;
...
class Blog_Grid extends Widget_Base {
	...
	public function get_title() {
		return __('Blog Grid', 'woovina-elementor-widgets');
	}

	public function get_icon() {
		// Upload "eicons.ttf" font via this site: http://bluejamesbond.github.io/CharacterMap/
		return 'wew-icon eicon-posts-grid';
	}
	...
	public function get_script_depends() {
		return [ 'wew-blog-grid', 'isotope', 'imagesloaded' ];
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_blog_grid',
			[
				'label' 		=> __('Blog Grid', 'woovina-elementor-widgets'),
			]
		);
		...
		$this->add_control(
			'count',
			[
				'label' 		=> __('Posts Per Page', 'woovina-elementor-widgets'),
				'description' 	=> __('You can enter "-1" to display all posts.', 'woovina-elementor-widgets'),
		...
		$this->add_responsive_control(
			'columns',
			[
				'label' 		=> __('Grid Columns', 'woovina-elementor-widgets'),
				...
				'selectors' => [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-entry' => 'width: calc(100% / {{VALUE}});',
				],
			]
		);
		...
		$this->add_control(
			'grid_style',
			[
				'label' 		=> __('Grid Style', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::SELECT,
				'default' 		=> 'fit-rows',
				'options' 		=> [
					'fit-rows' 	=> __('Fit Rows', 'woovina-elementor-widgets'),
					'masonry' 	=> __('Masonry', 'woovina-elementor-widgets'),
				],
			]
		);
		...
		$this->add_control(
			'grid_equal_heights',
			[
				'label' 		=> __('Equal Heights', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			'pagination_position',
			[
				'label' 		=> __('Pagination Position', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			'title',
			[
				'label' 		=> __('Display Title', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::SWITCHER,
				'default' 		=> 'yes',
		...
		$this->add_control(
			'author',
			[
				'label' 		=> __('Display Author', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::SWITCHER,
				'default' 		=> 'yes',
				'label_on' 		=> __('Show', 'woovina-elementor-widgets'),
				'label_off' 	=> __('Hide', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			'cat',
			[
				'label' 		=> __('Display Categories', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::SWITCHER,
				'default' 		=> 'yes',
				'label_on' 		=> __('Show', 'woovina-elementor-widgets'),
				'label_off' 	=> __('Hide', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			'excerpt',
			[
				'label' 		=> __('Display Excerpt', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::SWITCHER,
				'default' 		=> 'yes',
				'label_on' 		=> __('Show', 'woovina-elementor-widgets'),
				'label_off' 	=> __('Hide', 'woovina-elementor-widgets'),
		...
		$this->start_controls_section(
			'section_grid',
			[
				'label' 		=> __('Grid', 'woovina-elementor-widgets'),
		...
		$this->add_control(
			...
			[
				...
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-inner' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-inner' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'section_button',
			[
				'label' 		=> __('Overlay Button', 'woovina-elementor-widgets'),
				'tab' 			=> Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' 			=> 'button_typo',
				'selector' 		=> '{{WRAPPER}} .wew-blog-grid .wew-grid-media .overlay-btn',
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-media .overlay-btn' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-media .overlay-btn' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-media .overlay-btn' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-media .overlay-btn:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-media .overlay-btn:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-media .overlay-btn:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'section_avatar',
			[
				'label' 		=> __('Author Avatar', 'woovina-elementor-widgets'),
				'tab' 			=> Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-media .entry-author-link' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-details .wew-grid-title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-details .wew-grid-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' 			=> 'title_typo',
				'selector' 		=> '{{WRAPPER}} .wew-blog-grid .wew-grid-details .wew-grid-title',
				'scheme' 		=> Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-details .wew-grid-excerpt' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' 			=> 'excerpt_typo',
				'selector' 		=> '{{WRAPPER}} .wew-blog-grid .wew-grid-details .wew-grid-excerpt',
				'scheme' 		=> Scheme_Typography::TYPOGRAPHY_1,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-meta' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-meta, {{WRAPPER}} .wew-blog-grid .wew-grid-meta li a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .wew-blog-grid .wew-grid-meta li a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' 			=> 'meta_typo',
				'selector' 		=> '{{WRAPPER}} .wew-blog-grid .wew-grid-meta',
				'scheme' 		=> Scheme_Typography::TYPOGRAPHY_1,
			]
		);
	...
	public function get_img_sizes() {
		...
		$image_sizes['full'] 	= _x('Full', 'Image Size Control', 'woovina-elementor-widgets');
	...
	protected function render() {
		...
		if($wew_query->have_posts()) :
			...
			// Wrapper classes
			$wrap_classes = array('wew-blog-grid', 'clr');

			if('masonry' == $grid_style) {
				$wrap_classes[] = 'wew-masonry';
			}
			...
			<div class="<?php echo esc_attr($wrap_classes); ?>">
				...
				while($wew_query->have_posts()) : $wew_query->the_post();
					...
					// Inner classes
					$inner_classes 		= array('wew-grid-entry', 'clr');
					...
					if(has_post_thumbnail()
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class($inner_classes); ?>>
							...
							if('yes' == $title
								...
								<div class="wew-grid-inner clr">
							
									<?php
									// Display thumbnail if enabled and defined
									if(has_post_thumbnail()) { ?>

										<div class="wew-grid-media clr">

											<a href="<?php echo $post->permalink; ?>" title="<?php the_title(); ?>" class="wew-grid-img">
											...
											<?php if('yes' == $author) { ?>
												<a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>" title="<?php esc_attr_e('Visit Author Page', 'woovina-elementor-widgets'); ?>" class="entry-author-link" rel="author" >
													<?php
									...
									if('yes' == $title
										...
										<div class="wew-grid-details<?php echo esc_attr($details_class); ?> clr">

											<?php
											// Display title if $title is yes and there is a post title
											if('yes' == $title) { ?>

												<h2 class="wew-grid-title entry-title">
											...
											if('yes' == $excerpt) { ?>
												...
												<div class="wew-grid-excerpt clr">
													<?php wew_excerpt($settings['excerpt_length']); ?>
												</div>
												
											<?php } ?>

										</div><!-- .wew-grid-details -->
									...
									if('yes' == $comments
										...
										<ul class="wew-grid-meta<?php echo esc_attr($meta_class); ?> clr">
