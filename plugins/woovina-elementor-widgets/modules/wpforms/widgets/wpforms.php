<?php
namespace wvnElementor\Modules\WPForms\Widgets;
...
class WPForms extends Widget_Base {
	...
	public function get_title() {
		return __('WPForms', 'woovina-elementor-widgets');
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' 		=> __('Hide Title & Description', 'woovina-elementor-widgets'),
	...
	protected function render() {
		...
		if(('0' != $form && ! empty($form)) && !isset($forms[$form])) {
			$form = key($forms);
		}
