<?php
namespace wvnElementor\Modules\MotionFX;
...
class Controls_Group extends Group_Control_Base {
	...
	protected function init_fields() {
		$fields = [
			'motion_fx_scrolling' => [
				'label' => __( 'Scrolling Effects', 'woovina-elementor-widgets' ),
		...
		$fields['transform_origin_x'] = [
			'label' => __( 'X Anchor Point', 'woovina-elementor-widgets' ),
		...
		$fields['transform_origin_y'] = [
			'label' => __( 'Y Anchor Point', 'woovina-elementor-widgets' ),
			'type' => Controls_Manager::CHOOSE,
			'default' => 'center',
			'options' => [
				'top' => [
		...
		$fields['devices'] = [
			'label' => __( 'Apply Effects On', 'woovina-elementor-widgets' ),
		...
		$fields['motion_fx_mouse'] = [
			'label' => __( 'Mouse Effects', 'woovina-elementor-widgets' ),
			'type' => Controls_Manager::SWITCHER,
			'label_off' => __( 'Off', 'woovina-elementor-widgets' ),
			'label_on' => __( 'On', 'woovina-elementor-widgets' ),
			'separator' => 'before',
	...
	private function get_scrolling_effects() {
		return [
			'translateY' => [
				'label' => __( 'Vertical Scroll', 'woovina-elementor-widgets' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => __( 'Up', 'woovina-elementor-widgets' ),
							'negative' => __( 'Down', 'woovina-elementor-widgets' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'woovina-elementor-widgets' ),
					...
					'affectedRange' => [
						'label' => __( 'Viewport', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SLIDER,
						'default' => [
							'sizes' => [
								'start' => 0,
						...
						'labels' => [
							__( 'Bottom', 'woovina-elementor-widgets' ),
							__( 'Top', 'woovina-elementor-widgets' ),
						],
						'scales' => 1,
						'handles' => 'range',
					],
			...
			'translateX' => [
				'label' => __( 'Horizontal Scroll', 'woovina-elementor-widgets' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => __( 'To Left', 'woovina-elementor-widgets' ),
							'negative' => __( 'To Right', 'woovina-elementor-widgets' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'woovina-elementor-widgets' ),
			...
			'opacity' => [
				'label' => __( 'Transparency', 'woovina-elementor-widgets' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SELECT,
					...
					'level' => [
						'label' => __( 'Level', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SLIDER,
						'default' => [
							'size' => 10,
						],
			...
			'blur' => [
				'label' => __( 'Blur', 'woovina-elementor-widgets' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SELECT,
			...
			'rotateZ' => [
				'label' => __( 'Rotate', 'woovina-elementor-widgets' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SELECT,
			...
			'scale' => [
				'label' => __( 'Scale', 'woovina-elementor-widgets' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SELECT,
	...
	private function get_mouse_effects() {
		return [
			'mouseTrack' => [
				'label' => __( 'Mouse Track', 'woovina-elementor-widgets' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => __( 'Opposite', 'woovina-elementor-widgets' ),
							'negative' => __( 'Direct', 'woovina-elementor-widgets' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'woovina-elementor-widgets' ),
			...
			'tilt' => [
				'label' => __( '3D Tilt', 'woovina-elementor-widgets' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'woovina-elementor-widgets' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => __( 'Direct', 'woovina-elementor-widgets' ),
							'negative' => __( 'Opposite', 'woovina-elementor-widgets' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'woovina-elementor-widgets' ),
