...
class Media_Carousel extends Base {
	...
	public function get_name() {
		return 'wew-media-carousel';
	}

	public function get_title() {
		return __( 'Media Carousel', 'woovina-elementor-widgets' );
	}

	public function get_icon() {
		return 'wew-icon eicon-media-carousel';
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Lightbox', 'woovina-elementor-widgets' ),
		...
		$this->add_control(
			'lightbox_ui_color',
			[
				'label' => __( 'UI Color', 'woovina-elementor-widgets' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'UI Hover Color', 'woovina-elementor-widgets' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Video Width', 'woovina-elementor-widgets' ),
	...
	protected function add_repeater_controls( Repeater $repeater ) {
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'video' => [
						'title' => __( 'Video', 'woovina-elementor-widgets' ),
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'file' => __( 'Media File', 'woovina-elementor-widgets' ),
					'custom' => __( 'Custom URL', 'woovina-elementor-widgets' ),
				],
				'condition' => [
					'type' => 'image',
				],
		...
		$repeater->add_control(
			'video',
			[
				'label' => __( 'Video Link', 'woovina-elementor-widgets' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'Enter your video link', 'woovina-elementor-widgets' ),
				'description' => __( 'YouTube or Vimeo link', 'woovina-elementor-widgets' ),
				'show_external' => false,
				'condition' => [
					'type' => 'video',
				],
		...
		<div <?php echo $this->get_render_attribute_string( $element_key . '-image' ); ?>>
			<?php if ( 'video' === $slide['type'] && $settings['video_play_icon'] ) : ?>
				<div class="elementor-custom-embed-play">
					...
					<span class="elementor-screen-only"><?php _e( 'Play', 'woovina-elementor-widgets' ); ?></span>
				</div>
			<?php endif; ?>
		</div>
	...
	private function add_injections() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'carousel',
				'options' => [
					'carousel' => __( 'Carousel', 'woovina-elementor-widgets' ),
					'slideshow' => __( 'Slideshow', 'woovina-elementor-widgets' ),
					'coverflow' => __( 'Coverflow', 'woovina-elementor-widgets' ),
				],
		...
		$this->add_control(
			'image_fit',
			[
				'label' => __( 'Image Fit', 'woovina-elementor-widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => __( 'Cover', 'woovina-elementor-widgets' ),
					'contain' => __( 'Contain', 'woovina-elementor-widgets' ),
					'auto' => __( 'Auto', 'woovina-elementor-widgets' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'play_icon_title',
			[
				'label' => __( 'Play Icon', 'woovina-elementor-widgets' ),
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					'text_shadow_type' => [
						'label' => _x( 'Shadow', 'Text Shadow Control', 'woovina-elementor-widgets' ),
					],
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'caption' => __( 'Caption', 'woovina-elementor-widgets' ),
		...
		$this->add_control(
			'thumbs_title',
			[
				'label' => __( 'Thumbnails', 'woovina-elementor-widgets' ),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin' => 'slideshow',
				],
		...
		$this->add_control(
			'thumbs_ratio',
			[
				'label' => __( 'Ratio', 'woovina-elementor-widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => '219',
				'options' => [
					'169' => '16:9',
		...
		$this->add_control(
			'centered_slides',
			[
				'label' => __( 'Centered Slides', 'woovina-elementor-widgets' ),
