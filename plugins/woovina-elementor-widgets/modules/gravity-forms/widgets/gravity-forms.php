<?php
namespace wvnElementor\Modules\GravityForms\Widgets;
...
class Gravity_Forms extends Widget_Base {
	...
	public function get_title() {
		return __('Gravity Forms', 'woovina-elementor-widgets');
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'form_ajax',
			[
				'label' 		=> __('Use Ajax', 'woovina-elementor-widgets'),
				'description' 	=> __('Use ajax to submit the form', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::SWITCHER,
				'default' 		=> 'yes',
			]
		);
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' 		=> __('Labels & Descriptions', 'woovina-elementor-widgets'),
				'tab' 			=> Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'sent_heading',
			[
				'label' 		=> __('Thank You Message', 'woovina-elementor-widgets'),
				'type' 			=> Controls_Manager::HEADING,
				'separator' 	=> 'before',
			]
		);
