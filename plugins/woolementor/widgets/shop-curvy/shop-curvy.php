	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'separator' 	=> 'before',
				'selectors' 	=> [
                    '{{WRAPPER}} .wl-scr-product-info h2.wl-scr-price del' => 'display: {{VALUE}}',
                ],
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .wl-scr-product-info h2.wl-scr-price del .amount' => 'color: {{VALUE}}',
                ],
                'condition' => [
        ...
        $this->add_group_control(
			...
			[
				...
				'label' 	=> __( 'Typography', 'woolementor' ),
				'scheme' 	=> Scheme_Typography::TYPOGRAPHY_3,
				'selector' 	=> '{{WRAPPER}} .wl-scr-product-info h2.wl-scr-price del',
				'condition' => [
                    'sale_price_show_hide' => 'block'
                ],
			]
