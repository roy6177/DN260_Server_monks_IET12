...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<?php if( 'yes' == $section_heading_show_hide ): ?>
	 	<<?php echo $section_heading_tag; ?> class="wl-co-title"><?php esc_html_e( 'Cart totals', 'woocommerce' ); ?></<?php echo $section_heading_tag; ?>>
	<?php endif; ?>
