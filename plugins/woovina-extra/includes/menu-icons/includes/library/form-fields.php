...
abstract class WE_Form_Field {
	...
	protected static $types = array(
		'text'            => 'WE_Form_Field_Text',
		'number'          => 'WE_Form_Field_Text',
		'url'             => 'WE_Form_Field_Text',
		'color'           => 'WE_Form_Field_Text',
		'date'            => 'WE_Form_Field_Text',
		'hidden'          => 'WE_Form_Field_Text',
		'checkbox'        => 'WE_Form_Field_Checkbox',
		'radio'           => 'WE_Form_Field_Radio',
		'textarea'        => 'WE_Form_Field_Textarea',
		'select'          => 'WE_Form_Field_Select',
		'select_multiple' => 'WE_Form_Field_Select_Multiple',
		'select_pages'    => 'WE_Form_Field_Select_Pages',
		'special'         => 'WE_Form_Field_Special',
	);
	...
	*/
	...
	final public static function create(array $field, $args = array()) {
		...
		if(! isset(self::$types[ $field['type'] ])
			...
			trigger_error(
				sprintf(
					esc_html__('%1$s: Type %2$s is not supported, reverting to text.', 'woovina-extra'),
					__CLASS__,
					esc_html($field['type'])
				),
				E_USER_WARNING
 ...
 * Field: text
 */
class WE_Form_Field_Text extends WE_Form_Field {
 ...
 * Field: Textarea
 */
class WE_Form_Field_Textarea extends WE_Form_Field {
 ...
 * Field: Checkbox
 */
class WE_Form_Field_Checkbox extends WE_Form_Field {
 ...
 * Field: Radio
 */
class WE_Form_Field_Radio extends WE_Form_Field_Checkbox {
 ...
 * Field: Select
 */
class WE_Form_Field_Select extends WE_Form_Field {
 ...
 */
class WE_Form_Field_Select_Multiple extends WE_Form_Field_Select {
 ...
 * Field: Select Pages
 */
class WE_Form_Field_Select_Pages extends WE_Form_Field_Select {
 ...
 */
class WE_Form_Field_Special extends WE_Form_Field {
	public function render() {
