 ...
 *
 */
class WE_Icon_Picker_Type_Image extends WE_Icon_Picker_Type {
	...
	public function __construct($args = array()) {
		if(empty($this->name)) {
			$this->name = __('Image', 'woovina-extra');
		}
	...
	public function get_templates() {
		 ...
		 *
		 */
		$templates = apply_filters('we_icon_picker_image_media_templates', $templates);
	...
	protected function get_image_mime_types() {
		 ...
		 *
		 */
		$mime_types = apply_filters('we_icon_picker_image_mime_types', $mime_types);
