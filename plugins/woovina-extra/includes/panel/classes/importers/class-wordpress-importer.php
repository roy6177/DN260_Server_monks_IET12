...
require_once WE_PATH . '/includes/panel/classes/importers/compat.php';

// include WXR file parsers
require WE_PATH . '/includes/panel/classes/importers/class-parsers.php';
...
<?php
	...
	function process_menu_item( $item ) {
		...
		$field_name_suffix = array('nolink', 'category_post', 'megamenu', 'megamenu_auto_width', 'megamenu_col', 'megamenu_heading', 'icon', 'mega_template', 'megamenu_widgetarea');
		...
		// HieuJa added this code
		$key = 'we-icons';
		if(isset($$key)) {
			update_post_meta($id, 'we-icons', unserialize($$key));
		}
...
// Fix bug: can't import SVG files
function woovina_add_file_types_to_uploads($file_types){
	$new_filetypes 			= array();
...
add_filter('upload_mimes', 'woovina_add_file_types_to_uploads');