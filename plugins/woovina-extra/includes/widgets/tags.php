...
if(! class_exists('WooVina_Extra_Tags_Widget')) {
	class WooVina_Extra_Tags_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'woovina_tags',
				esc_html__('&raquo; Tags Cloud', 'woovina-extra'),
				array(
					'classname'   => 'widget-woovina-tags tags-widget',
					'description' => esc_html__('A cloud of your most used tags.', 'woovina-extra'),
		...
		public function form($instance) {
			...
			case 0:
				echo '<p>' . esc_html__('The tag cloud will not be displayed since there are no taxonomies that support the tag cloud widget.', 'woovina-extra') . '</p>';
				printf($input, '');
				break;
			...
			default:
				printf(
					...
					$id,
					esc_html__('Taxonomy:', 'woovina-extra'),
					$name
				);
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('padding')); ?>"><?php esc_html_e('Padding:', 'woovina-extra'); ?></label>
				...
				<small style="color: #777;"><?php esc_html_e('top left bottom right, eg: 15px 8px 15px 25px', 'woovina-extra'); ?></small>
			</p>

			<p>
				<label for="<?php echo esc_attr($this->get_field_id('bg_color')); ?>"><?php esc_html_e('Background Color:', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('bg_hover_color')); ?>"><?php esc_html_e('Background Hover Color:', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('link_color')); ?>"><?php esc_html_e('Link Color:', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('link_hover_color')); ?>"><?php esc_html_e('Link Hover Color:', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('border_color')); ?>"><?php esc_html_e('Border Color:', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('border_hover_color')); ?>"><?php esc_html_e('Border Hover Color:', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('font_size')); ?>"><?php esc_html_e('Font Size (px):', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('line_height')); ?>"><?php esc_html_e('Line Height (px):', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('letter_spacing')); ?>"><?php esc_html_e('Letter Spacing (px):', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('text_transform')); ?>"><?php esc_html_e('Text Transform:', 'woovina-extra'); ?></label>
				<select class="widget-select widefat" name="<?php echo esc_attr($this->get_field_name('text_transform')); ?>" id="<?php echo esc_attr($this->get_field_id('position')); ?>">
					<option value="default" <?php selected($instance['text_transform'], 'default') ?>><?php esc_html_e('Default', 'woovina-extra'); ?></option>
					<option value="capitalize" <?php selected($instance['text_transform'], 'capitalize') ?>><?php esc_html_e('Capitalize', 'woovina-extra'); ?></option>
					<option value="lowercase" <?php selected($instance['text_transform'], 'lowercase') ?>><?php esc_html_e('Lowercase', 'woovina-extra'); ?></option>
					<option value="uppercase" <?php selected($instance['text_transform'], 'uppercase') ?>><?php esc_html_e('Uppercase', 'woovina-extra'); ?></option>
					<option value="none" <?php selected($instance['text_transform'], 'none') ?>><?php esc_html_e('None', 'woovina-extra'); ?></option>
				</select>
			</p>
...
register_widget('WooVina_Extra_Tags_Widget');