...
if(! class_exists('WooVina_Extra_MailChimp_Widget')) {
	class WooVina_Extra_MailChimp_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'woovina_mailchimp',
				esc_html__('&raquo; MailChimp', 'woovina-extra'),
				array(
		...
		public function form($instance) {
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('mailchimpaction')); ?>"><?php esc_html_e('MailChimp Form Action', 'woovina-extra'); ?></label>
