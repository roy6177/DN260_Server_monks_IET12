...
if(! class_exists('WooVina_Extra_Contact_Info_Widget')) {
	class WooVina_Extra_Contact_Info_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'woovina_contact_info',
				esc_html__('&raquo; Contact Info', 'woovina-extra'),
				array(
					'classname'   => 'widget-woovina-contact-info',
					'description' => esc_html__('Adds support for contact info.', 'woovina-extra'),
		...
		public function social_widget_style() { ?>
			<style>
				.woovina-infos { background: #fafafa; padding: 16px 10px; border: 1px solid #e5e5e5; margin-bottom: 10px; }
				.woovina-infos h2 { font-size: 16px; margin: 0 0 10px; }
				.woovina-infos p { margin: 0 0 8px; }
				.woovina-infos p:last-child { margin: 0; }
				.woovina-infos label { margin-bottom: 3px; display: block; color: #222; }
			</style>
		<?php
		}
				...
				echo '<ul class="contact-info-widget '. esc_attr($style) .'">';
					...
					if($address) {
						echo '<li class="address">';
							...
							echo '<div class="woovina-info-wrap">';
								echo '<span class="woovina-contact-title">'. esc_html($address_text) .'</span>';
									if(! empty($address_link)) {
										echo '<a href="'. esc_url($address_link) .'" target="_'. esc_attr($target) .'">';
									}
									echo '<span class="woovina-contact-text">'. esc_html($address) .'</span>';
									if(! empty($address_link)) {
										echo '</a>';
									}
							echo '</div>';
					...
					if($phone) {
						echo '<li class="phone">';
							...
							echo '<div class="woovina-info-wrap">';
								echo '<span class="woovina-contact-title">'. esc_html($phone_text) .'</span>';
									if(! empty($phone_link)) {
										echo '<a href="tel:'. esc_attr($phone_link) .'">';
									}
									echo '<span class="woovina-contact-text">'. esc_html($phone) .'</span>';
									if(! empty($phone_link)) {
										echo '</a>';
									}
							echo '</div>';
					...
					if($mobile) {
						echo '<li class="mobile">';
							...
							echo '<div class="woovina-info-wrap">';
								echo '<span class="woovina-contact-title">'. esc_html($mobile_text) .'</span>';
									if(! empty($mobile_link)) {
										echo '<a href="tel:'. esc_attr($mobile_link) .'">';
									}
									echo '<span class="woovina-contact-text">'. esc_html($mobile) .'</span>';
									if(! empty($mobile_link)) {
										echo '</a>';
									}
							echo '</div>';
					...
					if($fax) {
						echo '<li class="fax">';
							...
							echo '<div class="woovina-info-wrap">';
								echo '<span class="woovina-contact-title">'. esc_html($fax_text) .'</span>';
								echo '<span class="woovina-contact-text">'. esc_html($fax) .'</span>';
							echo '</div>';
						echo '</li>';
					}
					...
					if($email) {
						echo '<li class="email">';
							...
							echo '<div class="woovina-info-wrap">';
								echo '<span class="woovina-contact-title">'. esc_html($email_text) .'</span>';
								echo '<span class="woovina-contact-text">';
					...
					if($web) {
						echo '<li class="web">';
							...
							echo '<div class="woovina-info-wrap">';
								echo '<span class="woovina-contact-title">'. esc_html($web_text) .'</span>';
								echo '<span class="woovina-contact-text">';
					...
					if($skype) {
						echo '<li class="skype">';
							echo '<a href="skype:'. esc_attr($skype) .'?call" target="_self" class="woovina-skype-button">';
								if($skypetxt) {
									echo esc_html($skypetxt);
								} else {
									esc_html__('Skype', 'woovina-extra');
								}
							echo '</a>';
						echo '</li>';
					}
		...
		public function form($instance) {
			...
			$instance = wp_parse_args((array) $instance, array(
				'title'         => esc_attr__('Contact Info', 'woovina-extra'),
				'style' 		=> esc_attr__('Default', 'woovina-extra'),
				...
				'address_text'  => esc_attr__('Address:', 'woovina-extra'),
				'address'       => esc_attr__('Street Name, FL 54785', 'woovina-extra'),
				'address_link'  => '',
				'phone_icon'  	=> 'icon-phone',
				'phone_text'  	=> esc_attr__('Phone:', 'woovina-extra'),
				'phone' 		=> '621-254-2147',
				'phone_link' 	=> '',
				'mobile_icon'  	=> 'icon-screen-smartphone',
				'mobile_text'  	=> esc_attr__('Mobile:', 'woovina-extra'),
				'mobile' 		=> '621-254-2147',
				'mobile_link'  	=> '',
				'fax_icon'  	=> 'icon-printer',
				'fax_text'  	=> esc_attr__('Fax:', 'woovina-extra'),
				'fax' 			=> '621-254-2147',
				'email_icon'  	=> 'icon-envelope',
				'email_text'  	=> esc_attr__('Email:', 'woovina-extra'),
				'email' 		=> 'contact@support.com',
				'emailtxt' 		=> 'contact@support.com',
				'web_icon'  	=> 'icon-link',
				'web_text'  	=> esc_attr__('Website:', 'woovina-extra'),
				'web' 			=> '#',
				'webtxt' 		=> 'yourwebsite.com',
				'skype' 		=> 'YourUsername',
				'skypetxt' 		=> esc_html__('Skype Call Us', 'woovina-extra'),
			)); ?>
			...
			<p>
				...
				<select class='widefat' name="<?php echo $this->get_field_name('style'); ?>" id="<?php echo $this->get_field_id('style'); ?>">
					<option value="default" <?php if($instance['style'] == 'default') { ?>selected="selected"<?php } ?>><?php esc_html_e('Default', 'woovina-extra'); ?></option>
					<option value="big-icons" <?php if($instance['style'] == 'big-icons') { ?>selected="selected"<?php } ?>><?php esc_html_e('Big Icons', 'woovina-extra'); ?></option>
					<option value="no-icons" <?php if($instance['style'] == 'no-icons') { ?>selected="selected"<?php } ?>><?php esc_html_e('No Icons', 'woovina-extra'); ?></option>
				</select>
			</p>

			<p>
				<label for="<?php echo esc_attr($this->get_field_id('text')); ?>"><?php esc_html_e('Text', 'woovina-extra'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('target')); ?>"><?php esc_html_e('Links Target', 'woovina-extra'); ?></label>
			...
			<div class="woovina-infos">
				<h2><?php esc_html_e('Address:', 'woovina-extra'); ?></h2>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('address_icon')); ?>"><?php esc_html_e('Icon Class', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('address_text')); ?>"><?php esc_html_e('Title', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Content', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('address_link')); ?>"><?php esc_html_e('Link (optional)', 'woovina-extra'); ?></label>
			...
			<div class="woovina-infos">
				<h2><?php esc_html_e('Phone:', 'woovina-extra'); ?></h2>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('phone_icon')); ?>"><?php esc_html_e('Icon Class', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('phone_text')); ?>"><?php esc_html_e('Title', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Content', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('phone_link')); ?>"><?php esc_html_e('Link (optional)', 'woovina-extra'); ?></label>
			...
			<div class="woovina-infos">
				<h2><?php esc_html_e('Mobile:', 'woovina-extra'); ?></h2>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('mobile_icon')); ?>"><?php esc_html_e('Icon Class', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('mobile_text')); ?>"><?php esc_html_e('Title', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('mobile')); ?>"><?php esc_html_e('Content', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('mobile_link')); ?>"><?php esc_html_e('Link (optional)', 'woovina-extra'); ?></label>
			...
			<div class="woovina-infos">
				<h2><?php esc_html_e('Fax:', 'woovina-extra'); ?></h2>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('fax_icon')); ?>"><?php esc_html_e('Icon Class', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('fax_text')); ?>"><?php esc_html_e('Title', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('fax')); ?>"><?php esc_html_e('Content', 'woovina-extra'); ?></label>
			...
			<div class="woovina-infos">
				<h2><?php esc_html_e('Email:', 'woovina-extra'); ?></h2>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('email_icon')); ?>"><?php esc_html_e('Icon Class', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('email_text')); ?>"><?php esc_html_e('Title', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('URL', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('emailtxt')); ?>"><?php esc_html_e('URL Text', 'woovina-extra'); ?></label>
			...
			<div class="woovina-infos">
				<h2><?php esc_html_e('Website:', 'woovina-extra'); ?></h2>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('web_icon')); ?>"><?php esc_html_e('Icon Class', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('web_text')); ?>"><?php esc_html_e('Title', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('web')); ?>"><?php esc_html_e('URL', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('webtxt')); ?>"><?php esc_html_e('URL Text', 'woovina-extra'); ?></label>
			...
			<div class="woovina-infos">
				<h2><?php esc_html_e('Skype:', 'woovina-extra'); ?></h2>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('skype')); ?>"><?php esc_html_e('Username', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('skypetxt')); ?>"><?php esc_html_e('Text', 'woovina-extra'); ?></label>
...
register_widget('WooVina_Extra_Contact_Info_Widget');