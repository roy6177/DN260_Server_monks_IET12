...
update_site_option('dig_purchasecode', '8699958a-77f3-4db8-9422-126b0836e1c5');
                ...
                if ($type == "dropdown" && $user_role == 1) {
                    ...
                    foreach ($values['options'] as $option) {
                        ...
                        echo '<div class="dig_opt_mult" >
                            ...
                            <input ' . $re . ' name="digits_reg_' . $meta_key . $ar . '" ' . $custom_class . ' id="digits_reg_for_' . $meta_key . '_' . $option . $rand . '" type="' . $type . '" value="' . $option . '" ' . $selected . '>
