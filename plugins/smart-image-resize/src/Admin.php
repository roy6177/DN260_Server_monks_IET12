...
/* __END_PRO__ */
        ...
        function settings_field_enable_webp()
        {
            ...
            <p class="description">
                <?php _e(
                    "WebP reduces image file size by up to 90% comparing to PNG images without losing quality.<br>Fall back to legacy formats for browsers that can't display WebP images.",
                    WP_SIR_NAME
                ); ?>
            </p>
            <?php
...
/* __END_PRO__ */
        ...
        function settings_field_sizes()
        {
            ...
            <select multiple="multiple" id="wpSirResizeSizes" name="wp_sir_settings[sizes][]">
                <?php foreach ( wp_sir_get_additional_sizes() as $key => $size ) :
                    ?>
        ...
        function add_settings_help()
        {
            ...
            $screen->add_help_tab( array(
                ...
                'content' =>
                    ...
                    '<p><strong>Enable WebP format:</strong> WebP is the rockstart of image formats. Using WebP can dramatically reduce image file size without losing the quality of the image. WebP is widely supported by all modern browsers, otherwise, it fall backs automatically to standard image.</p>'
            ) );
