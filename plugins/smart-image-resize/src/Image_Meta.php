...
class Image_Meta
{
    ...
    /**
     * Set this to true if the given image metadata array is correct.
     *
     * @var bool $isValid
     */
    ...
    public function getOriginalFullPath( $extension = false )
    {
        ...
        return path_join( $uploadsDir,
            trailingslashit( $this->getRelativeDirectory() ) . pathinfo( $this->data[ 'file' ],
    ...
    public function getSizeFullPath( $sizeName, $extension = false )
    {
        ...
        return path_join( $uploadsDir,
            trailingslashit( $this->getRelativeDirectory() ) . pathinfo( $sizeData[ 'file' ],
                PATHINFO_FILENAME ) . '.' . $extension );
    }
    ...
    public function getOriginalUrl( $extension = false )
    {
        ...
        return $uploadsUrl . '/' . trailingslashit( $this->getRelativeDirectory() ) . pathinfo( $this->data[ 'file' ],
                PATHINFO_FILENAME ) . '.' . $extension;
    }
    ...
    public function getSizeUrl( $sizeName, $extension = false )
    {
        ...
        return $baseUrl . pathinfo( $sizeData[ 'file' ],
                PATHINFO_FILENAME ) . '.' . $extension;
    }

    public function getSizes( $keysOnly = false )
    {
        return $keysOnly
