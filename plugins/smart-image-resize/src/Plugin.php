...
if (! class_exists('\WP_Smart_Image_Resize\Plugin')) :
    class Plugin
    {
        ...
        public function load_dependencies()
        {
            ...
            require_once WP_SIR_DIR.'src/Image_Filters/Webpify_Filter.php';
            require_once WP_SIR_DIR.'src/Image_Filters/Resize_Filter.php';
            ...
            require_once WP_SIR_DIR.'src/File_Helper.php';
